...
[kintone](https://kintone.cybozu.co.jp/) と [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) を連携させるためのDenoサーバー実装です。Claude DesktopからkintoneのデータをAIで操作・分析できます。
